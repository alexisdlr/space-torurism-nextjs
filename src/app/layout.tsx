...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${fontVariables} h-dvh overflow-x-hidden antialiased`}
    >
      <body className="flex h-dvh flex-col overflow-x-hidden font-barlow 2xl:max-w-screen-xl 2xl:mx-auto">
        <Navbar />
